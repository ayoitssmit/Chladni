...
export default function ControlPanel({
  ...
  return (
    <div className="glass-panel h-full flex flex-col">
      <div className="p-5 flex flex-col gap-5 overflow-y-auto accent-scrollbar flex-1">
        {/* Header */}
        <div>
          <h2
      ...
      {/* Buttons */}
      <div className="p-5 flex flex-col gap-2 shrink-0" style={{ borderTop: "1px solid var(--border-subtle)", background: "var(--surface-800)" }}>
        {!isRunning ? (
          <button
            onClick={handleStart}
