  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <main className="flex-1 min-h-0 overflow-auto p-3">
        <div className="h-full gap-3 dashboard-grid grid grid-cols-1 md:grid-cols-[280px_1fr] grid-rows-[auto_1fr_1fr] md:grid-rows-[1fr_1fr]">
          {/* Control Panel */}
          <div className="md:row-span-2 min-h-0 w-[280px] shrink-0">
            <ControlPanel
